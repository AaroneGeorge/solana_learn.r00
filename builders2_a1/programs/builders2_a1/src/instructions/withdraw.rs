...
impl<'info> Withdraw<'info> {
    pub fn withdraw(
        ...
        // Slippage protection:user is trying to withdraw too much 
        // and their price is worse than they expected, 
    ...
    pub fn burn_lp_tokens(&self, amount: u64) -> Result<()> {
        ...
        burn(ctx, amount)?; // CPI fn that burns the user's LP tokens
        Ok(())
    }
}